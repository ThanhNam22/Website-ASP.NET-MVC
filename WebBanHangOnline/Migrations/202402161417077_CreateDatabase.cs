namespace WebBanHangOnline.Migrations
{
    ...
    public partial class CreateDatabase : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OrderDetail", "SizeId", "dbo.tb_Sizes");
            ...
            DropForeignKey("dbo.tb_OrderDetail", "ColorId", "dbo.tb_Colors");
            ...
            DropIndex("dbo.tb_OrderDetail", new[] { "SizeId" });
            DropIndex("dbo.tb_OrderDetail", new[] { "ColorId" });
